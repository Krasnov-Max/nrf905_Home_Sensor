...
#define NRF905_CS_Pin GPIO_PIN_12
#define NRF905_CS_GPIO_Port GPIOB
#define NRF905_CLK_Pin GPIO_PIN_13
#define NRF905_CLK_GPIO_Port GPIOB
#define NRF905_MISO_Pin GPIO_PIN_14
#define NRF905_MISO_GPIO_Port GPIOB
#define NRF905_MOSI_Pin GPIO_PIN_15
#define NRF905_MOSI_GPIO_Port GPIOB
#define NRF905_PWR_Pin GPIO_PIN_6
#define NRF905_PWR_GPIO_Port GPIOC
#define NRF905_CE_Pin GPIO_PIN_7
#define NRF905_CE_GPIO_Port GPIOC
#define NRF905_TXEN_Pin GPIO_PIN_8
#define NRF905_TXEN_GPIO_Port GPIOC
#define NRF905_DR_Pin GPIO_PIN_9
#define NRF905_DR_GPIO_Port GPIOC
#define NRF905_AM_Pin GPIO_PIN_8
#define NRF905_AM_GPIO_Port GPIOA
#define NRF905_CD_Pin GPIO_PIN_9
#define NRF905_CD_GPIO_Port GPIOA

#define SPI_INSTANCE_NRF						&hspi2
...
#define NRF905_CS_HI	HAL_GPIO_WritePin(NRF905_CS_GPIO_Port, NRF905_CS_Pin, GPIO_PIN_SET)
#define NRF905_CS_LO	HAL_GPIO_WritePin(NRF905_CS_GPIO_Port, NRF905_CS_Pin, GPIO_PIN_RESET)
#define NRF905_CE_HI	HAL_GPIO_WritePin(NRF905_CE_GPIO_Port, NRF905_CE_Pin, GPIO_PIN_SET)
#define NRF905_CE_LO	HAL_GPIO_WritePin(NRF905_CE_GPIO_Port, NRF905_CE_Pin, GPIO_PIN_RESET)
